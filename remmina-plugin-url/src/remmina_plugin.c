...
{
  TRACE_CALL("remmina_plugin_url_init");
...
{
  TRACE_CALL("remmina_plugin_url_open_connection");
...
{
  TRACE_CALL("remmina_plugin_url_close_connection");
...
static RemminaProtocolPlugin remmina_plugin =
{
  ...
  remmina_plugin_url_basic_settings,            // Array for basic settings
  NULL,                                         // Array for advanced settings
  REMMINA_PROTOCOL_SSH_SETTING_NONE,            // SSH settings type
  NULL,                                         // Array for available features
  remmina_plugin_url_init,                      // Plugin initialization
  remmina_plugin_url_open_connection,           // Plugin open connection
  remmina_plugin_url_close_connection,          // Plugin close connection
...
{
  TRACE_CALL("remmina-plugin-url::remmina_plugin_entry");
